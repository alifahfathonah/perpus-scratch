...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?=site_url('peminjaman/index/submit')?>" id="form-peminjaman" method='post'>
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" value="<?=date('Y-m-d')?>" name="tanggal" class='form-control' readonly>
                    </div>
                </div>
                <div class="form-group col-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="time" value="<?=date('H:m:s')?>" name="waktu" class='form-control' readonly>
                    </div>
                </div>
            </div>
            <div class="row">
